...
<body>
    ...
    <form action="../Logica/LNActualizarEmpresa.php" method="post" name="   ">
        ...
        <table border=1px>
            ...
            <tr>
                <td>idEmpresa</td>
                <td><input type="text" name="idEmpresa" id="idEmpresa" placeholder="ingrese el id" required
            ...
            <tr>
                ...
                <td><input type="text" name="nit" id="nit" placeholder="ingrese el nit" required pattern="[0-9-Aa-Zz]+"
                        title="solo numeros y caracteres " value="<?php echo $datosEmpresa['nit'] ?>"> </td>
            </tr>

            <tr>
                <td>Nombre</td>
                <td><input type="text" name="nombre" id="nombre" placeholder="Ingrese el nombre Empresa" required
                        pattern="[A-Za-z]+" title="solo caracteres" value="<?php echo $datosEmpresa['nombre'] ?>"></td>
            </tr>

            <tr>
                <td>Direccion</td>
                <td><input type="text" name="direccion" id="direccion" placeholder="Ingrese su Segundo direccion"
                        required pattern="[A-Za-z]+" title="solo caracteres"
            ...
            <tr>
                <td>Telefono</td>
                <td><input type="number" name="telefono" id="telefono" placeholder="solo numeros" required
                        pattern="[0-9]{8}" value="<?php echo $datosEmpresa['telefono'] ?>"> </td>
            </tr>

            <tr>
                <td>Descripcion</td>
                <td><input type="text" name="descripcion" id="descripcion" placeholder="Ingrese la descripcion" required
                        pattern="[A-Za-z]+" value="<?php echo $datosEmpresa['descripcion'] ?>"></td>
            </tr>
            <tr>
                <td>Activo</td>
                <td>
